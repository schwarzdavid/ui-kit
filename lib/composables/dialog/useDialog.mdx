...
import * as InfoDialogContent from "./docs/internal/InfoDialog.stories";
import * as DialogOutlet from './docs/internal/DialogOutlet.stories.ts'
import * as PromptDialogStories from "./docs/internal/PromptDialog.stories.ts";
import * as ConfirmDialogStories from "./docs/internal/ConfirmDialog.stories.ts";
...
First, anywhere inside your application and inside the `VApp` Vuetify-component, place the `DialogOutlet`. This component renders the later created dialogs. It is recommended to use the root component of your application for this (`App.vue`).
...
<template>
    <VApp>
        ...
        <DialogOutlet/>    <-- This need to be INSIDE the VApp
    </VApp>
</template>

<script lang="ts" setup>
    import {DialogOutlet} from "@schwarzdavid/ui-kit";
</script>
```

After the DialogOutlet is placed anywhere in your application, you can call one of the provided functions to create a predefined dialog in your individual components. See the documentation below.
